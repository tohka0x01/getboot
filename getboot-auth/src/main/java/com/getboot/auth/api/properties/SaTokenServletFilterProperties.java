...
/**
 * Sa-Token Servlet 认证过滤配置。
 *
 * <p>用于统一定义 Servlet 入口的认证匹配规则、预检请求豁免策略和认证失败响应。</p>
 *
 * @author qiheng
 */
@ConfigurationProperties(prefix = "getboot.auth.satoken.servlet.filter")
public class SaTokenServletFilterProperties {
